...
// Ruta de inicio del dashboard según rol
...
<template>
  <header class="dashboard-topbar">
    <div class="topbar-left">
      ...
      <!-- Mi Panel ahora es un botón que navega al inicio del dashboard -->
      <button class="topbar-home-btn" @click="goToHome" title="Ir al inicio del panel">
        <span class="material-symbols-outlined topbar-home-icon">dashboard</span>
...
.topbar-icon-btn:hover {
  background: rgba(197, 140, 242, 0.14);
  border-color: rgba(197, 140, 242, 0.4);
  color: var(--button-purple, #c58cf2);
  box-shadow: 0 2px 8px rgba(197, 140, 242, 0.2);
}
